...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(`${VENDOR_API_URL}/v1/products/${id}`, {
      headers: {
...
export async function PUT(
  ...
  try {
    ...
    console.error('Error en PUT /api/vendor/products/[id]:', error);
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    console.error('Error en DELETE /api/vendor/products/[id]:', error);
    return NextResponse.json(
